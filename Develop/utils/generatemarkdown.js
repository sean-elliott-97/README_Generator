...
function renderLicenseBadge(license) {
  ...
  function generateMarkdown(data) {
    ...
    * [Questions](#questions)
    ...
    ## Questions
    ---
    My other work can be found at <a href="https://github.com/${data.github}" title="github profile" target = "blank">${data.github}</a>. If you have any additional questions, you can email me at [${
      data.email
    }](mailto:${data.email}).
